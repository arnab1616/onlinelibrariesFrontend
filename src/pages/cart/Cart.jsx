...
export const Cart = () => {
  ...
  console.log('Cart items', books, books.filter(item => cartItems.includes(item.id)));
  return (
        ...
        <div className='cart-container'>
          <div className='cart-list-section'>
            <div className='cart-list-container'>
              {books.map((book, index) => cartItems.includes(parseInt(book.id)) && (
              ...
              {cartItems?.length <= 0 && <p>No cart items found</p>}
            </div>
          </div>
